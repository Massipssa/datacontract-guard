...
python -B -m contract_agent.cli \
  --source-schema examples/schemas/source_schema.json \
  --contract examples/contracts/customer_contract.yaml
```
...
```bash
python -B -m contract_agent.cli \
  --source-schema examples/samples/customers_bad.csv \
  --contract examples/contracts/customers_contract.yaml \
